...
def write_operator_block(x, parameters, precision, taxa):
    ...
    if parameters.continuous_phylogeo:
        ...
        write_swapoperator_block(tmp, "location.rrwCategories", size='1', weight="30", auto_optimize="false")
        write_uniformintegeroperator_block(tmp, "location.rrwCategories", weight='10')
