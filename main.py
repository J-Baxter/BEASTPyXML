...
def main():
    ...
    root = etree.Element('BEAST X', version='10.5.0')
    comment = etree.Comment('Generated by BEASTPyXML - a software to write simple BEAST XMLs for high-throughput analyses.')
    root.insert(1, comment)
    comment = etree.Comment('by James Baxter')
    root.insert(1, comment)
    comment = etree.Comment('Roslin Institute, The University of Edinburgh')
    root.insert(1, comment)
